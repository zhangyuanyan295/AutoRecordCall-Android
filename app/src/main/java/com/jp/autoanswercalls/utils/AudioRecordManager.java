...
public class AudioRecordManager {
    ...
    public AudioRecordManager() {
        ...
        mRecorder = new AudioRecord(MediaRecorder.AudioSource.VOICE_DOWNLINK, frequency, AudioFormat.CHANNEL_CONFIGURATION_MONO, AudioFormat.ENCODING_PCM_16BIT, bufferSize*2);
    }
